	...
	<div class="register">
		<div class="container">
			...
			<form class="form-horizontal form-register" method="POST" action="">
				...
				<div class="form-group">
					<label for="inputFname" class="col-xs-12 control-label">Practical Identity Number (No Izin Praktek)</label>
					<div class="col-xs-12">
				      <input type="text" class="form-control input-error" id="inputFname" placeholder="Identity Number" name="no_praktek">
				      <span class="error"><?php echo form_error('no_praktek')?></span>
				    </div>
				</div>
				<div class="form-group">
 			...
 			<div class="form-group container">
 				...
 				<a href="<?php echo base_url('page/register')?>"> Sign Up as Patient?</a>
 			</div>
